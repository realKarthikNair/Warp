...
.modules |= map(if .name=="warp" then .["sources"] = [{type: "dir", path: "../", skip: ["target", "build", "_build", "builddir", "build-aux/app", ".flatpak", "build-aux/.flatpak", "build-aux/.flatpak-builder", "flatpak_out", "flatpak_repo", ".fenv"]}] else . end) |
